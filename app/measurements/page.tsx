      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <button
            ...
            className="px-6 py-3 bg-purple-600 hover:bg-purple-700 rounded-lg font-medium text-white transition-all shadow-lg shadow-purple-500/50 flex items-center gap-2"
          >
          ...
          <button
            ...
            className="px-6 py-3 bg-cyan-600 hover:bg-cyan-700 rounded-lg font-medium text-white transition-all shadow-lg shadow-cyan-500/50 flex items-center gap-2"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-purple-900/30 to-blue-900/20 rounded-lg border border-purple-500/30 p-6">
            ...
            <div className="flex items-end gap-2 mb-2">
              <div className="text-4xl font-bold text-white">{stats.current.weight}</div>
              <div className="text-gray-400 mb-1">lbs</div>
            </div>
          ...
          <div className="bg-gradient-to-br from-cyan-900/30 to-blue-900/20 rounded-lg border border-cyan-500/30 p-6">
            ...
            <div className="flex items-end gap-2 mb-2">
              <div className="text-4xl font-bold text-white">{stats.current.bodyFat.toFixed(1)}</div>
          ...
          <div className="bg-gradient-to-br from-green-900/30 to-emerald-900/20 rounded-lg border border-green-500/30 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-white">Waist</h3>
            </div>
            <div className="flex items-end gap-2 mb-2">
              <div className="text-4xl font-bold text-white">{stats.current.waist.toFixed(1)}</div>
          ...
          <div className="bg-gradient-to-br from-yellow-900/30 to-orange-900/20 rounded-lg border border-yellow-500/30 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-white">Muscle Mass</h3>
            </div>
            <div className="flex items-end gap-2 mb-2">
              <div className="text-4xl font-bold text-white">{stats.current.muscleMass.toFixed(1)}</div>
              <div className="text-gray-400 mb-1">lbs</div>
            </div>
            <div className={`flex items-center gap-1 text-sm ${
          ...
          <div className="bg-gradient-to-br from-orange-900/30 to-red-900/20 rounded-lg border border-orange-500/30 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-white">Chest</h3>
            </div>
            <div className="flex items-end gap-2 mb-2">
              <div className="text-4xl font-bold text-white">{stats.current.chest.toFixed(1)}</div>
              <div className="text-gray-400 mb-1">in</div>
            </div>
          ...
          <div className="bg-gradient-to-br from-pink-900/30 to-purple-900/20 rounded-lg border border-pink-500/30 p-6">
            ...
            <div className="flex items-end gap-2 mb-2">
              <div className="text-4xl font-bold text-white">{stats.current.bmi.toFixed(1)}</div>
            </div>
        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-white">Measurement Trends</h2>
            <select
        ...
        <div className="space-y-6">
          ...
          {comparisonMode && selectedPhotos.length > 0 && (
            <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
              <h3 className="text-xl font-bold text-white mb-4">Photo Comparison</h3>
                ...
                {selectedPhotos.map(photoId => {
                  ...
                  return (
                    <div key={photoId} className="space-y-2">
                      ...
                      />
                      <div className="text-center">
                        <div className="text-white font-medium capitalize">{photo.type}</div>
                        <div className="text-sm text-gray-400">
        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
          <h2 className="text-2xl font-bold text-white mb-6">Detailed Measurements</h2>
            ...
            <table className="w-full text-sm text-gray-300">
              <thead className="bg-gray-700">
                <tr>
                  ...
                  <th className="px-4 py-3 text-right">Waist</th>
                  <th className="px-4 py-3 text-right">Chest</th>
                  <th className="px-4 py-3 text-right">Bicep (L/R)</th>
              ...
              <tbody className="divide-y divide-gray-700">
                {mockMeasurements.slice().reverse().map(m => (
                  <tr key={m.id} className="hover:bg-gray-700/50">
                    ...
                    <td className="px-4 py-3 text-right">{m.weight} lbs</td>
                    <td className="px-4 py-3 text-right">{m.bodyFat?.toFixed(1)}%</td>
                    <td className="px-4 py-3 text-right">{m.measurements.waist?.toFixed(1)} in</td>
                    <td className="px-4 py-3 text-right">{m.measurements.chest?.toFixed(1)} in</td>
                    <td className="px-4 py-3 text-right">
                      {m.measurements.bicepLeft?.toFixed(1)} / {m.measurements.bicepRight?.toFixed(1)} in
                    </td>
                    <td className="px-4 py-3 text-gray-400">{m.notes || '-'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
